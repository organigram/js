# Organigr.am JavaScript SDK
Organigr.am JS SDK ables web apps to integrate with IPFS and Ethereum and update their organigrams in a completely decentralized way.  
Users data can be easily encrypted using OpenPGP.js before ever leaving the computer.

## Installation
```
yarn add ipfs web3 @organigram/sdk
```
