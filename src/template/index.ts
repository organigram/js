...
export const renewSaltsAndAddresses = (
  ...
  const organs = organigram.organs?.map(organ => ({
    ...
    isSource: organ.isSource?.map(source => ({
      ...
      procedureAddress:
        newProcedureAddresses[source.procedureAddress!] ??
    ...
    isTarget: organ.isTarget
      ?.map(target => ({
        ...
        procedureAddress:
          newProcedureAddresses[target.procedureAddress!] ??
  ...
  const procedures = organigram.procedures?.map(procedure => ({
    ...
    sourceOrgans: procedure.sourceOrgans
      ...
      .filter(
        sourceOrgan =>
          newProcedureAddresses[sourceOrgan.procedureAddress!] !== undefined &&
    ...
    targetOrgans: procedure.targetOrgans
      ...
      .filter(
        targetOrgan =>
          newProcedureAddresses[targetOrgan.procedureAddress!] !== undefined &&
