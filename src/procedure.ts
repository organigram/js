...
import { cidToMultihash, multihashToCid } from './ipfs'
...
export default class Procedure {
    ...
    static async loadData(address:Address):Promise<{
        ...
        const metadata:CID|null = multihashToCid(data.metadata)
        return {
            metadata,
    ...
    static async loadProposal(
        ...
        const metadata:CID|null = multihashToCid(proposal.metadata)
        const blockReason:CID|null = multihashToCid(proposal.blockReason)
